...
*   [[Architecture]]: Understand the double-agent loop, orchestrated pipelines, and Google ADK simulation graphs.
*   [[Agent Skills and MCP]]: Explore the active skills package, FastMCP server, and in-loop tool usage.
*   [[Security Model]]: Dive into rate limiting, request size bounding, and filesystem sandboxing.
